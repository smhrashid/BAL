...
class Mricipt_model extends CI_Model {
   ...
   public function get_col() {
	  ...
	  $query_up_val ="UPDATE $scima SET CR_NO=('AB'||lpad(VPC_MERCHTXNREF_SEQ.nextval+1,8,0)),STATUS='SUCCESS',NOS_PREMNO=1 where USER_ID='$user' and id_no ='$orderid' and status is null and CR_NO is null and NET_RECIV='$netrec'";
